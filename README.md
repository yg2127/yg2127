...
- **Capstone Design (2026.03 – present)** — Driver Abnormal Behavior Detection under IR / Occlusion Domain Shift
  Extending the ST-GCN backbone from my Heart Lab internship into a domain-shift problem.
...
- **Heart Lab, Sejong University — Undergraduate Research Intern** (2025.06 – 2025.10)
  ST-GCN-based driver abnormal behavior classification on the *100 Driver Dataset*.
